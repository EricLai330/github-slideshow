  ...
  constructor(
    ...
    private http: HttpClient) 
    {
      ...
      toggleSection(index) {
        ...
        console.log('.global.sorted=',this.global.sorted);
        ...
        console.log('information[index].open=',this.information[index].open);
        console.log('automaticClose=',this.automaticClose);
    ...
    //console.log('atteOne iArray=',iArray); 
        ...
        if(iArray[0] != null){
          ...
          this.information[1].children[1].children[0].name += this.global.currentAttenuator;  //Attenuation,Position,min
          this.information[1].children[1].children[1].name += this.global.currentAttenuator;   //max
        }
    //console.log('tempOne=',this.global.tempOne);
        ...
        if(iArray[0] != null){
          ...
          this.information[2].children[1].name += this.tempConvert(this.global.currentTemperature);  //min
          this.information[2].children[2].name += this.tempConvert(this.global.currentTemperature);  //max
        }
        ...
        if(iArray[0] != null){
          ...
          this.information[3].children[0].children[1].name += this.global.current24V;  //min
          this.information[3].children[0].children[2].name += this.global.current24V;  //max
        }
    //console.log('i24vrOne=',this.global.i24vrOne);  
        ...
        if(iArray[0] != null){
          ...
          this.information[3].children[1].children[1].name += this.global.current24VR;  //min
          this.information[3].children[1].children[2].name += this.global.current24VR;  //max
        }           
      } //sortingData
